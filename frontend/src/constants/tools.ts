...
export const CONVERSION_TYPES: ConversionType[] = [
  ...
  { 
    ...
    faqs: [
      ...
      { question: 'Is transparency preserved?', answer: 'Yes, if the original GIF had transparency, the PNG output will also have transparency and better quality through full alpha channel support.' },
    ]
  },
  { 
    id: 'webp-to-jpg', 
  ...
  { 
    ...
    longDescription: 'Extract PDF pages as lossless PNG files with our free converter. Unlike JPG, PNG uses lossless compression so your document pages are captured with perfect clarity. Every line of text and graphic element stays razor-sharp. This is the best choice for sharing document pages where text readability is critical, or when you need to embed document content in websites, emails, or digital presentations.',
    faqs: [
